...
public class FieldExtensionDHKeyExchange_Test extends TestCase {
	...
	/* Sage Script generating the above values:
		F.<x> = GF(52435875175126190479447740508185965837690552500527637822603658699938581184513)[]
		K.<a> = GF(52435875175126190479447740508185965837690552500527637822603658699938581184513**4, name='a', modulus=x^4-7)
